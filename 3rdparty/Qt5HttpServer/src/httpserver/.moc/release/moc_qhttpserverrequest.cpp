...
static const uint qt_meta_data_QHttpServerRequest[] = {
 ...
 // enum data: key, value
       2, uint(QHttpServerRequest::Method::Unknown),
       3, uint(QHttpServerRequest::Method::Get),
       4, uint(QHttpServerRequest::Method::Put),
       5, uint(QHttpServerRequest::Method::Delete),
       6, uint(QHttpServerRequest::Method::Post),
       7, uint(QHttpServerRequest::Method::Head),
       8, uint(QHttpServerRequest::Method::Options),
       9, uint(QHttpServerRequest::Method::Patch),
      10, uint(QHttpServerRequest::Method::Connect),
      11, uint(QHttpServerRequest::Method::All),
      12, uint(QHttpServerRequest::Method::GET),
      13, uint(QHttpServerRequest::Method::PUT),
      14, uint(QHttpServerRequest::Method::DELETE),
      15, uint(QHttpServerRequest::Method::POST),
      16, uint(QHttpServerRequest::Method::HEAD),
      17, uint(QHttpServerRequest::Method::OPTIONS),
      18, uint(QHttpServerRequest::Method::PATCH),
      19, uint(QHttpServerRequest::Method::CONNECT),
       2, uint(QHttpServerRequest::Method::Unknown),
       3, uint(QHttpServerRequest::Method::Get),
       4, uint(QHttpServerRequest::Method::Put),
       5, uint(QHttpServerRequest::Method::Delete),
