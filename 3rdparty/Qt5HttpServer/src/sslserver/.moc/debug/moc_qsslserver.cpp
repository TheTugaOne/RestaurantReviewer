...
QT_MOC_LITERAL(3, 22, 11), // "QSslSocket*"
QT_MOC_LITERAL(4, 34, 6), // "socket"
QT_MOC_LITERAL(5, 41, 16), // "QList<QSslError>"
QT_MOC_LITERAL(6, 58, 6) // "errors"

    },
    "QSslServer\0sslErrors\0\0QSslSocket*\0"
    "socket\0QList<QSslError>\0errors"
};
...
void QSslServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sslErrors((*reinterpret_cast< QSslSocket*(*)>(_a[1])),(*reinterpret_cast< const QList<QSslError>(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (QSslServer::*)(QSslSocket * , const QList<QSslError> & );
...
QT_INIT_METAOBJECT const QMetaObject QSslServer::staticMetaObject = { {
    &QTcpServer::staticMetaObject,
    qt_meta_stringdata_QSslServer.data,
    qt_meta_data_QSslServer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
